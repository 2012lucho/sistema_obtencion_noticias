...
ID_DIARIO = 4
BASE_URL  = "https://derechadiario.com.ar"
...
def procesar_elementos( url, cat_id, categoria ):
    ...
    elementos = soup.find(class_="category-posts").find_all("div")
    ...
    for elemento in elementos:
        ...
        try:
            ...
            nota["titulo"] = soup_esp.find(class_="content_title").text
            nota["contenido"] = soup_esp.find(class_="content_text").decode_contents()
