...
ID_DIARIO = 5
BASE_URL  = "https://www.diariodecuyo.com.ar"
...
def procesar_elementos( url, cat_id, categoria ):
    ...
    for elemento in elementos:
        ...
        try:
            ...
            nota["titulo"] = soup_esp.find(class_="nota-top-part").find("h1").text
            nota["contenido"] = soup_esp.find(class_="article-body").decode_contents()
